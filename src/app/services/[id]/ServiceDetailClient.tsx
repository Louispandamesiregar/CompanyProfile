      ...
      <main className="flex-1 bg-background">
        ...
        <section className="relative h-[40vh] md:h-[60vh] min-h-[400px] w-full flex items-center justify-center overflow-hidden">
          ...
          <div className="container mx-auto px-6 md:px-12 relative z-10 pt-20">
            <Link 
              href="/" 
              className="inline-flex items-center text-sm font-bold text-white bg-white/20 hover:bg-white/30 border border-white/30 backdrop-blur-md transition-all mb-6 px-4 py-2 rounded-full shadow-lg"
            >
