...
export function ContactSection() {
  ...
  const { contact } = content.companyInfo
  
  return (
    <section id="contact" className="py-24 bg-gradient-to-b from-card/50 to-background scroll-m-16 overflow-hidden relative">
              ...
              return (
                ...
                >
                  ...
                  <div className="ml-4 flex-1 text-left">
                    <h3 className="font-semibold text-xl mb-0.5 text-foreground transition-colors">WhatsApp ({c.name})</h3>
                    <p className="text-muted-foreground text-sm">{c.whatsapp}</p>
                  </div>
