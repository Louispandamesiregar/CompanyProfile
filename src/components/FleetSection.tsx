  ...
  return (
    <section className="pt-8 md:pt-12 pb-8 md:pb-12 bg-white relative overflow-hidden border-t border-border/50">
      ...
      <motion.div 
        ...
        className="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-slate-50 to-transparent pointer-events-none" 
      />
            ...
            {FLEET_DATA.map((fleet) => (
              <motion.button
                ...
                className={`w-full text-left p-5 rounded-2xl transition-all duration-300 flex items-center justify-between group ${
                  activeId === fleet.id 
                    ? 'bg-gradient-to-r from-blue-700 to-slate-900 text-white shadow-xl shadow-blue-900/20' 
